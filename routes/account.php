...
Route::resource('provider', 'Resource\DriverResource');
Route::get('requests/{id}', 'Resource\RideResource@Accountshow')->name('requests.show');

Route::group(['as' => 'provider.'], function () {
    Route::get('provider/{id}/statement', 'Resource\DriverResource@Accountstatement')->name('statement');
});
