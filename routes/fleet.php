...
Route::get('requests', 'Resource\RideResource@Fleetindex')->name('requests.index');
Route::delete('requests/{id}', 'Resource\RideResource@Fleetdestroy')->name('requests.destroy');
Route::get('requests/{id}', 'Resource\RideResource@Fleetshow')->name('requests.show');
Route::get('scheduled', 'Resource\RideResource@Fleetscheduled')->name('requests.scheduled');
