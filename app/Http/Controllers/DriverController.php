...
class DriverController extends Controller
{
    ...
    {
        $provider = Drivers::where('id',\Auth::guard('provider')->user()->id)
    ...
    {
        (new DriverResources\ProfileController)->available($request);
        return back();
    }
    ...
    {
        $fully = (new DriverResources\TripController)->upcoming_trips();
