...
class SocialLoginController extends Controller
{
    ...
    public function handleFacebookCallback(Request $request){
        ...
        if($token = $AccessToken['access_token']){
            ...
            if($guard == 'provider') {
                if($facebook->id){
                    $FacebookSql = Drivers::where('social_unique_id',$facebook->id);
                    if($facebook->email !=""){
                ...
                if($facebook->id){
                    $FacebookSql = Users::where('social_unique_id',$facebook->id);
                    if($facebook->email !=""){
                        $FacebookSql->orWhere('email',$facebook->email);
                    }
                    $AuthUser = $FacebookSql->first();
    ...
    public function facebookViaAPI(Request $request) { 
        ...
        try{
        	...
        	$FacebookSql = Users::where('social_unique_id',$FacebookDrive->id);
    ...
    public function handleGoogleCallback(){
        try{
            ...
            if($google){
                ...
                if($guard == 'provider') {
                    if($google->id){
                        $GoogleSql = Drivers::where('social_unique_id',$google->id);
                        if($google->email !=""){
                    ...
                    if($google->id){
                        $GoogleSql = Users::where('social_unique_id',$google->id);
                        if($google->email !=""){
                            $GoogleSql->orWhere('email',$google->email);
                        }
                        $AuthUser = $GoogleSql->first();
    ...
    public function googleViaAPI(Request $request) { 
        ...
        try{
            ...
            $GoogleSql = Users::where('social_unique_id',$GoogleDrive->id);
    ...
    public function account_kit(Request $request){
        ...
        // Method to send Get rides to url
        function doCurl($url) {
          $ch = curl_init();
