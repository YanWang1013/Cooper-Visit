...
namespace App\Http\Controllers\DriverResources;
...
class TripController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            if($request->ajax()) {
                ...
                $Provider = Auth::guard('driver')->user();
            }
    ...
    public function history(Request $request)
    {
        ...
        $Jobs = UserRequests::where('provider_id', Auth::guard('driver')->user()->id)->with('user', 'service_type', 'payment', 'rating')->get();
        return view('driver.trip.index', compact('Jobs'));
    }
    ...
    public function accept(Request $request, $id)
    {
        try {
            ...
            if($UserRequest->schedule_at != ""){
                ...
                ProviderService2::where('provider_id',$UserRequest->provider_id)->update(['status' =>'riding']);
        ...
        try {
            ...
            */ 
            ...
            if($UserRequest->use_wallet == 1 && $Total > 0){
                ...
                $User = Users::find($UserRequest->user_id);
                ...
                if($Wallet != 0){
                    ...
                    if($Total > $Wallet) {
                        ...
                        Users::where('id',$UserRequest->user_id)->update(['wallet_balance' => 0 ]);
                        ...
                        Users::where('id',$UserRequest->user_id)->update(['wallet_balance' => $WalletBalance]);
