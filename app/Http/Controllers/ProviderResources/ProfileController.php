...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            Auth::user()->service = ProviderService2::where('provider_id',Auth::user()->id)
                                            ->with('service_type')
                                            ->first();
        ...
        try {
            ...
            if($request->has('service_type')) {
                if($Provider->service) {
                    ...
                    //$ProviderService2 = ProviderService2::where('provider_id',Auth::user()->id);
            ...
            return response()->json(['error' => 'Drivers Not Found!'], 404);
        }
    }
    ...
    public function location(Request $request)
    {
        ...
        if($Provider = Auth::user()){
            ...
            return response()->json(['error' => 'Drivers Not Found!']);
        }
    }
    ...
    public function available(Request $request)
    {
        ...
        if($Provider->service) {
            ...
            $OfflineOpenRequest = RequestFilter::with(['rides.provider','rides'])
                ->where('provider_id', $provider)
                ->whereHas('rides', function($query) use ($provider){
