...
class TokenController extends Controller
{
    ...
    public function authenticate(Request $request)
    {
        ...
        Config::set('auth.drivers.users.model', 'App\Drivers');
        ...
        $User = Drivers::with('service', 'device')->find(Auth::user()->id);
    ...
    public function logout(Request $request)
    {
        try {
            ...
            ProviderService2::where('provider_id',$request->id)->update(['status' => 'offline']);
    ...
    public function forgot_password(Request $request){
        ...
        try{  
            ...
            $provider = Drivers::where('email' , $request->email)->first();
    ...
    public function reset_password(Request $request){
        ...
        try{
            ...
            $Provider = Drivers::findOrFail($request->id);
    ...
    public function facebookViaAPI(Request $request) { 
        ...
        try{
            $FacebookSql = Drivers::where('social_unique_id',$FacebookDrive->id);
            ...
            if($AuthUser){ 
                ...
                $AuthUser["mobile"]=$request->mobile?:'';
                $AuthUser["login_by"]="facebook";
                $AuthUser = Drivers::create($AuthUser);
            ...
            if($AuthUser){ 
                ...
                $User = Drivers::with('service', 'device')->find($AuthUser->id);
                if($User->device) {
                    ProviderDevice::where('id',$User->device->id)->update([
    ...
    public function googleViaAPI(Request $request) { 
        ...
        try{
            $GoogleSql = Drivers::where('social_unique_id',$GoogleDrive->id);
    ...
    public function refresh_token(Request $request)
    {
        ...
        $Provider = Drivers::with('service', 'device')->find(Auth::user()->id);
