    ...
    <div class="full-page-bg-inner">
        <div class="row no-margin">
            <div class="col-md-6 log-left">
                ...
                <h2><b>Use your coOper account & get picked up fast!</b></h2>
                <b><p>Welcome to coOper App, the reliable way to get to your destination of choice & to explore the attractions, events and other venues in The Bahamas. Available on demand or upon scheduled request. On time every time.</p></b>
            </div>
            <div class="col-md-6 log-right">
                ...
                <div class="login-box row no-margin">
                    ...
                    {{ csrf_field() }}                      
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="log-teal-btn">ENTER</button>
                        </div>
                    </form>
                    ...
                    <div class="col-md-12">
                        <p class="helper"> <a href="{{ url('/password/reset') }}">Can't Remember Password huh?</a></p>   
                    </div>
                </div>

                <div class="log-copy"><p class="no-margin"> © 2019 CoOper App Ltd.</p></div></div>
            </div>
        </div>
    </div>
</div>
