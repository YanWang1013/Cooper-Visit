    ...
    <div class="full-page-bg-inner">
        <div class="row no-margin">
            <div class="col-md-6 log-left">
                ...
                <h2><b>Create a coOper rider account & start your journey</b></h2>
                <strong><p>Welcome to coOper App, the reliable and quick way to move about.</p></strong>
            </div>
            <div class="col-md-6 log-right">
                ...
                <div class="login-box row no-margin">
                    <div class="col-md-12">
                        ...
                        <h3>Create a New coOper Account</h3>
                    </div>
                    <form role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div id="first_step">
                            ...
                            <div class="col-md-8">
                                <input type="text" autofocus id="phone_number" class="form-control" placeholder="242XXXXXXX (no spaces)" name="phone_number" value="{{ old('phone_number') }}" />
                            </div>
                            ...
                            <div class="col-md-12" style="padding-bottom: 10px;" id="mobile_verfication">
                                <input type="button" class="log-teal-btn small" onclick="smsLogin();" value="Verify Your Mobile Number"/>
                            </div>
                    ...
                    <div class="col-md-12">
                        <p class="helper">Or <a href="{{route('login')}}">Login</a> with your coOper App rider account.</p>   
                    </div>
