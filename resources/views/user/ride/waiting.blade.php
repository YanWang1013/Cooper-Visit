			...
			changeLabel : function(){
				if(this.props.checkState == undefined){
					...
					if(this.props.checkState.status == 'SEARCHING'){
						...
						var driver_name = this.props.checkState.provider.first_name;
						$("#ride_status").text(driver_name+" @lang('user.ride.accepted_ride')");
					}else if(this.props.checkState.status == 'ARRIVED'){
						var driver_name = this.props.checkState.provider.first_name;
						$("#ride_status").text(driver_name+" @lang('user.ride.arrived_ride')");
						...
						var driver_name = this.props.checkState.provider.first_name;
						$("#ride_status").text("@lang('user.ride.rate_and_review') " +driver_name );
					}
					setTimeout(function(){
						$('.rating').rating();
					},400);
