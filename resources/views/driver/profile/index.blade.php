...
<div class="pro-dashboard-head">
    <div class="container">
        ...
        <a href="{{ route('driver') }}" class="pro-head-link">Update Location</a>
    </div>
</div>
        ...
        <div class="container">
            <div class="profile-head white-bg row no-margin">
                <div class="prof-head-left col-lg-2 col-md-2 col-sm-3 col-xs-12">
                    <div class="new-pro-img bg-img" style="background-image: url({{ Auth::guard('driver')->user()->avatar ? asset('storage/'.Auth::guard('driver')->user()->avatar) : asset('driver') }});"></div>
                </div> 
                                ...
                                <div class="row no-margin">
                                    ...
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-right-padding">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  placeholder="Car Model" class="form-control" name="service_model" value="{{ Auth::guard('driver')->user()->service->service_model ? Auth::guard('driver')->user()->service->service_model : "" }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
