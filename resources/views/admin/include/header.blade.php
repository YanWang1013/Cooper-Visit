	...
	<nav class="navbar navbar-light">
		<div class="navbar-left">
			<a class="navbar-brand" href="{{url('admin/dashboard')}}">
				<!-- <div class="logo" style="background: 'https://visit.trycooper.com/logo-black.png' no-repeat;"></div> -->
				<img style="height: 30px; margin-bottom: 15px;" src="{{ asset('logo-black.png') }}">
			</a>
