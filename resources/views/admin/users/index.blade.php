            ...
            <table class="table table-striped table-bordered dataTable" id="table-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($user->status == \App\Constants::$USER_STATUS_ACTIVED || $user->status == \App\Constants::$USER_STATUS_TRAVELED)
                        ...
                        <td>
                            <form action="{{ route('admin.user.destroy', $user->id) }}" method="POST">
                                ...
                                <a href="{{ route('admin.user.payment_history', $user->id) }}" class="btn btn-info"><i class="fa fa-search"></i> @lang('admin.payment.payment_history')</a>
