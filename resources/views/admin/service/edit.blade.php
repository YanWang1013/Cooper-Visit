    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="driver_name" class="col-xs-2 col-form-label">@lang('admin.service.Provider_Name')</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->driver_name }}" name="driver_name" required id="driver_name" placeholder="Driver Name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <label for="marker_url" class="col-xs-2 col-form-label">Marker Image</label>
                    <div class="col-xs-10">
                        @if(isset($service->marker_url))
                            <img style="height: 90px; margin-bottom: 15px; border-radius:2em;" src="{{ $service->marker_url }}">
                        @endif
                        <input type="file" accept="image/*" name="marker_url" class="dropify form-control-file" id="marker_url" aria-describedby="fileHelp">
                    </div>
                </div>
...
{{--                    <div class="col-xs-10">--}}
{{--                        <input class="form-control" type="text" value="" name="hour" id="hour" placeholder="Set Hour Price (Only For @lang('servicetypes.DISTANCEHOUR'))">--}}
{{--                    </div>--}}
{{--                </div>--}}
