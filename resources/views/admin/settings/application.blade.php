            ...
            <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
	                    ...
	                    <img style="height: 90px; margin-bottom: 15px;" src="{{ asset('logo-black.png') }}">
	                    @endif
				...
				<div class="form-group row">
					<label for="driver_select_timeout" class="col-xs-2 col-form-label">@lang('admin.setting.Provider_Accept_Timeout')</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('driver_select_timeout', '60')  }}" name="driver_select_timeout" required id="driver_select_timeout" placeholder="Provider Timout">
					</div>
				</div>

				<div class="form-group row">
					<label for="driver_search_radius" class="col-xs-2 col-form-label">@lang('admin.setting.driver_search_radius')</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('driver_search_radius', '100')  }}" name="driver_search_radius" required id="driver_search_radius" placeholder="Provider Search Radius">
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="twilio_sid" class="col-xs-2 col-form-label">@lang('admin.setting.twilio_sid')</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('twilio_sid')  }}" name="twilio_sid" required id="twilio_sid" placeholder="@lang('admin.setting.twilio_sid')">
					</div>
				</div>

				<div class="form-group row">
					<label for="twilio_token" class="col-xs-2 col-form-label">@lang('admin.setting.twilio_token')</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('twilio_token')  }}" name="twilio_token" required id="twilio_token" placeholder="@lang('admin.setting.twilio_token')">
					</div>
				</div>

				<div class="form-group row">
					<label for="twilio_trial_number" class="col-xs-2 col-form-label">@lang('admin.setting.twilio_trial_number')</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('twilio_trial_number')  }}" name="twilio_trial_number" required id="twilio_trial_number" placeholder="@lang('admin.setting.twilio_trial_number')">
					</div>
				</div>
