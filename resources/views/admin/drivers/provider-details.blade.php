    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
            	<h4>@lang('admin.drivers.Provider_Details')</h4>
            	<div class="row">
            		<div class="col-md-12">
							...
							<div class="u-content">
								...
								<p class="text-muted">
									@if($provider->is_approved == 1)
										<span class="tag tag-success">@lang('admin.drivers.Approved')</span>
									@else
										<span class="tag tag-success">@lang('admin.drivers.Not_Approved')</span>
									@endif
								</p>
								...
								<p class="text-muted">
									@if($provider->is_activated == 1)
										<span class="tag tag-warning">">@lang('admin.drivers.Activated')</span>
									@else
										<span class="tag tag-warning">">@lang('admin.drivers.Not_Activated')</span>
									@endif
								</p>
							</div>
						</div>
