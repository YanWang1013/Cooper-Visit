...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">@lang('admin.drivers.add_provider')</h5>
            ...
            <form class="form-horizontal" action="{{route('admin.driver.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="password_confirmation" class="col-xs-12 col-form-label">@lang('admin.drivers.password_confirmation')</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-primary">@lang('admin.drivers.add_provider')</button>
