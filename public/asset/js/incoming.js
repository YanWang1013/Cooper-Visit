        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.requests.length > 0) {
                    // console.log('data.requests[0]', data.requests[0].rides);
...
class ModalComponent extends React.Component {
    ...
    _accept(event) {
        ...
        console.log('Accept');
        $.ajax({
            url: '/provider/rides/'+this.props.request.id,
            dataType: 'json',
            headers: {'X-CSRF-TOKEN': window.Laravel.csrfToken },
            type: 'POST',
            success: function(data) {
...
class TripRatingButton extends React.Component {
    ...
    _submit(event) {
        ...
        $.ajax({
            url: '/provider/rides/'+this.props.request+'/rate',
            dataType: 'json',
            data: {
...
class TripDetails extends React.Component {
    ...
    render() {
        ...
        // console.log("this.props.rides.user.picture", this.props.rides.user.picture);
...
class TripComponent extends React.Component {
    ...
    componentDidUpdate() {
        // console.log('Trip Component '+this.props.rides.id);
    ...
    render() {
        console.log('Check after rides completed', this.props.service_status);
